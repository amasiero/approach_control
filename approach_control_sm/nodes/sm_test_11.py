...
def setup_sm():
    ...
    with sm:
        ...
        with sm_con_1:
          ...
          smach.Concurrence.add('DAMMED', Say.Say("GOSH The bootle is not here too"))
        ...
        smach.StateMachine.add('QUESTION', Say.Say("Could please help me find my bottle"),
        ...
        smach.StateMachine.add('FOLLOW', Say.Say("Please follow me outside"),
